...
const deviceSchema = new mongoose.Schema({
  ...
  financingPlanId: { type: mongoose.Schema.Types.ObjectId, ref: 'FinancingPlan' },
  ...
  status: { type: String, enum: ['active', 'locked', 'offline', 'recovered'], default: 'active' },
  locationHistory: [{
    latitude: Number,
    longitude: Number,
    timestamp: { type: Date, default: Date.now },
  ...
  tamperAttempts: [{
    type: { type: String, enum: ['factory_reset', 'uninstall', 'root', 'other'] },
    timestamp: { type: Date, default: Date.now },
